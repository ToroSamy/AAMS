...
class AddOneAdmin(AbstractFrame):
    ...
    def onClick(self, event):
        ...
        if eventId == 1:
            ...
            self.addOneAdmin(userKeyName, userKeyId, userKeyPhone, userChoiceSex, userKeyPassword1, userKeyPassword2)

    def addOneAdmin(self, userKeyName, userKeyId, userKeyPhone, userChoiceSex, userKeyPassword1, userKeyPassword2):
        ...
        if not userKeyPassword1 == userKeyPassword2:
            ...
            return
        if userChoiceSex:
            admin = Admin(userKeyName, userKeyId, userKeyPassword1, userKeyPhone, "男")
        else:
            admin = Admin(userKeyName, userKeyId, userKeyPassword1, userKeyPhone, "女")
        self.aams.adminList.append(admin)
        Save(self.aams)
        MessageFrame(f"添加成功!")
